...
import type { AiAction, Card, PlayedSet, Player } from "@/types/game";
...
export function decideAiAction(player: Player, currentTrick: PlayedSet | null): AiAction {
  const cards = currentTrick ? selectResponsePlay(player.hand, currentTrick) : selectLeadPlay(player.hand);
